...
Route45_MapEvents:
	...
	def_warp_events
	warp_event  3,  5, DARK_CAVE_BLACKTHORN_ENTRANCE, 1
	warp_event 11,  1, ROUTE_45_BLACKTHORN_GATE, 3

	def_coord_events

	def_bg_events
	bg_event 10,  4, BGEVENT_READ, Route45Sign
	bg_event 10, 76, BGEVENT_ITEM, Route45HiddenPpUp
	...
	object_event 11, 85, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route45FruitTree, -1
