...
; Johto hidden items
	...
	const_skip ; unused in Crystal
	const_skip ; unused in Crystal
	const EVENT_NATIONAL_PARK_HIDDEN_THUNDERSTONE
	const EVENT_OLIVINE_LIGHTHOUSE_5F_HIDDEN_WATER_STONE
	const EVENT_TEAM_ROCKET_BASE_B1F_HIDDEN_FIRE_STONE
	const EVENT_TEAM_ROCKET_BASE_B2F_HIDDEN_FULL_HEAL
	const EVENT_ILEX_FOREST_HIDDEN_ETHER
	const EVENT_ILEX_FOREST_HIDDEN_HP_UP
	const EVENT_ILEX_FOREST_HIDDEN_LEAF_STONE
	const EVENT_GOLDENROD_UNDERGROUND_HIDDEN_HEAVY_BALL
	const EVENT_GOLDENROD_UNDERGROUND_HIDDEN_HYPER_POTION
	const EVENT_GOLDENROD_UNDERGROUND_HIDDEN_CARBOS
	...
	const EVENT_ICE_PATH_B2F_BLACKTHORN_SIDE_HIDDEN_MOON_STONE
	...
	const EVENT_SILVER_CAVE_ROOM_1_HIDDEN_FULL_RESTORE
	...
	const EVENT_ROUTE_30_HIDDEN_CARBOS
	const EVENT_ROUTE_32_HIDDEN_FAST_BALL
	const EVENT_ROUTE_32_HIDDEN_HP_UP
	const EVENT_ROUTE_34_HIDDEN_RARE_CANDY
	const EVENT_ROUTE_34_HIDDEN_MAX_ETHER
	...
	const EVENT_AZALEA_TOWN_HIDDEN_RARE_CANDY
...
; New to Crystal
	...
	const EVENT_PICKED_UP_KABUTO_FROM_KABUTO_ITEM_ROOM
	...
	const EVENT_PICKED_UP_OMANYTE_FROM_OMANYTE_ITEM_ROOM
	...
	const EVENT_PICKED_UP_AERODACTYL_FROM_AERODACTYL_ITEM_ROOM
